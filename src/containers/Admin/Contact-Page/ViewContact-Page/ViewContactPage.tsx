...
import { updateContactStatus } from "@/app/admin/contact/[id]/actions";
...
import { contactFields } from "@/const/admin/Form/contact";
...
function ViewContactPageContainer({ contact }: { contact: GetContactResDto }) {
  const { formData, loading, handleChange, handleSubmit } = useEntityActionForm(
    {
      mode: "edit",
      formFields: contactFields,
      initialData: buildFormDataFromDto(contact, contactFields),
      redirectPath: "/admin/contact",
  ...
  return (
    <>
      <HeaderTitle
        title="View Message"
        subTitle="See the message sent by client and take action."
      />
